...
.. note::
   Falls mehrere der vordefinierten Attributwerte unter dem Attribut "Fehler" zum Mängelpunkt resp. Mängellinie passt, ist nur ein Mängelpunkt resp. eine Mängellinie zu erfassen. Eventuell ist bei solchen Fällen der Attributwert "weitere" zu verwenden.
